...
<style>
    ...
    .btn-simpan { background: #0f172a; color: #ffffff; flex: 2; }
...
<div class="form-container">
    <div style="width: 100%; max-width: 560px;">
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            <h2 class="text-utama">Tambah Kategori</h2>
            <p class="text-sub">Kelompokkan aset Anda agar lebih mudah dicari dan dikelola secara sistematis.</p>
        </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" 
                           ...
                           placeholder="Misal: Perangkat Fotografi atau Elektronik" 
                           value="{{ old('name') }}" 
                           required 
                           autofocus>
                    @error('name') 
                ...
                <div style="margin-bottom: 10px;">
                    <label class="label-gaya">Keterangan (Opsional)</label>
                    <textarea name="description" 
                              rows="3" 
                              class="input-gaya @error('description') input-error @enderror" 
                              style="resize: none;"
                              placeholder="Jelaskan secara singkat kegunaan kategori ini...">{{ old('description') }}</textarea>
                    @error('description') 
                        <div class="pesan-error">{{ $message }}</div> 
                    @enderror
                </div>
                ...
                {{-- Navigasi Aksi --}}
                <div class="btn-group">
                    <button type="submit" class="btn-aksi btn-simpan">Simpan Kategori</button>
